...
// in simulator we redefine to format for MyDoc Developer console
...
{\
	NSString * exceptionName = [@"org.mydoc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mydoc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMyDocNativeItemNone = -1, 
	UIMyDocNativeItemSpinner = -2,
	UIMyDocNativeItemProgressBar = -3,
	
	UIMyDocNativeItemSlider = -4,
	UIMyDocNativeItemSwitch = -5,
	UIMyDocNativeItemMultiButton = -6,
	UIMyDocNativeItemSegmented = -7,
	
	UIMyDocNativeItemTextView = -8,
	UIMyDocNativeItemTextField = -9,
	UIMyDocNativeItemSearchBar = -10,
	
	UIMyDocNativeItemPicker = -11,
	UIMyDocNativeItemDatePicker = -12,
	
	UIMyDocNativeItemInfoLight = -13,
	UIMyDocNativeItemInfoDark = -14,
	
	UIMyDocNativeItemDisclosure = -15,
	
	UIMyDocNativeItemContactAdd = -16
};
